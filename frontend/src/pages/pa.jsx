...
const QuickNestLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-white w-full overflow-hidden">
      ...
      {/* Services Section */}
      {/* Unique Bento-Style Services Section */}
      <section
        id="services"
        className="py-24 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800 w-full relative overflow-hidden"
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-500/20 rounded-full blur-[120px] animate-pulse"
        ...
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-16 relative z-10">
          ...
          >
            <motion.div
              className="inline-flex items-center gap-2 px-5 py-2 bg-white/5 backdrop-blur-xl rounded-full border border-white/10 mb-6"
            ...
            <p className="text-xl text-gray-400 leading-relaxed">
              Discover our curated selection of professional services, each
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 auto-rows-fr">
              {/* Featured Large Card - Plumbing (Spans 2 columns & 2 rows) */}
              <motion.div
              ...
              >
                <div className="h-full relative bg-gradient-to-br from-cyan-500/10 via-blue-600/10 to-indigo-700/10 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:border-cyan-400/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(6,182,212,0.3)]">
                  {/* Gradient Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                  {/* 3D Tilt Effect Container */}
                  <div className="relative h-full p-8 md:p-10 flex flex-col justify-between transform group-hover:scale-[1.02] transition-transform duration-500">
                    {/* Top Section */}
                    <div>
                      {/* Icon with Glow */}
                      <div className="relative mb-8 inline-flex">
                        <div className="absolute inset-0 bg-cyan-500/30 blur-2xl rounded-full" />
                        <div className="relative bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-700 p-6 rounded-2xl shadow-2xl transform group-hover:rotate-6 group-hover:scale-110 transition-all duration-500">
                          <Wrench className="w-12 h-12 text-white" />
                        </div>
                        <div className="absolute -top-2 -right-2 bg-white/90 backdrop-blur-sm rounded-xl px-3 py-1.5 shadow-2xl flex items-center gap-1.5">
                      ...
                      <Badge className="mb-4 bg-cyan-500/20 text-cyan-300 border-cyan-400/30 backdrop-blur-sm">
                        Most Popular
                      </Badge>
                      ...
                      <p className="text-gray-300 text-lg leading-relaxed mb-6">
                        Expert plumbers available 24/7 for emergencies,
                        installations, and repairs. From leak fixes to complete
                        system overhauls.
                      </p>
                      ...
                      {/* Voice Hint */}
                      <div className="p-4 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 backdrop-blur-sm rounded-xl border border-cyan-400/20 mb-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">
                              "Book plumber tomorrow at 10 AM"
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button
                        className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white shadow-lg hover:shadow-cyan-500/50 transform hover:-translate-y-1 transition-all duration-300 font-semibold"
                        onClick={() => handleBookService("plumber", "Plumbing")}
                      >
                        Book Now
                      ...
                      <Button
                        variant="outline"
                        className="flex-1 border-2 border-white/20 hover:border-cyan-400/50 bg-white/5 hover:bg-white/10 text-white backdrop-blur-sm transition-all duration-300"
                        onClick={() =>
                          navigate(
                            `/services?skill=${encodeURIComponent("plumber")}`
                          )
                        }
                      >
                        View Pros
              ...
              {/* Electrical - Tall Card */}
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: 0.2 }}
                viewport={{ once: true }}
                className="lg:col-span-5 lg:row-span-1 group relative"
              >
                <div className="h-full relative bg-gradient-to-br from-amber-400/10 via-orange-500/10 to-red-600/10 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:border-amber-400/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(251,191,36,0.3)]">
                  <div className="relative h-full p-6 flex flex-col justify-between">
                    {/* Icon */}
                    <div className="relative mb-4 inline-flex">
                      <div className="absolute inset-0 bg-amber-500/30 blur-xl rounded-full" />
                      <div className="relative bg-gradient-to-br from-amber-400 via-orange-500 to-red-600 p-4 rounded-xl shadow-xl transform group-hover:rotate-6 transition-all duration-500">
                        <Zap className="w-8 h-8 text-white" />
                      </div>
                      <div className="absolute -top-1 -right-1 bg-white/90 backdrop-blur-sm rounded-lg px-2 py-1 shadow-lg flex items-center gap-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                        Licensed electricians for installations, repairs, and
                      ...
                      {/* Voice Hint */}
                      <div className="p-3 bg-amber-500/10 backdrop-blur-sm rounded-lg border border-amber-400/20 mb-4">
                        <p className="text-xs text-amber-300 font-medium">
                          💬 "Book electrician tomorrow morning"
                        </p>
                      </div>
                    </div>

                    <Button
                      className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white shadow-md hover:shadow-amber-500/30 transition-all duration-300"
                      onClick={() =>
                        handleBookService("electrician", "Electrical")
                      }
                    >
                      Book Now
                      <ArrowRight className="ml-2 w-4 h-4" />
              ...
              <motion.div
                ...
                className="lg:col-span-5 lg:row-span-1 group relative"
              >
                <div className="h-full relative bg-gradient-to-br from-pink-500/10 via-rose-500/10 to-purple-600/10 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:border-pink-400/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(236,72,153,0.3)]">
                  <div className="relative h-full p-6 flex flex-col justify-between">
                    <div className="relative mb-4 inline-flex">
                      <div className="absolute inset-0 bg-pink-500/30 blur-xl rounded-full" />
                      <div className="relative bg-gradient-to-br from-pink-500 via-rose-500 to-purple-600 p-4 rounded-xl shadow-xl transform group-hover:rotate-6 transition-all duration-500">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                        Professional beauticians and stylists at your doorstep
                      ...
                      <div className="p-3 bg-pink-500/10 backdrop-blur-sm rounded-lg border border-pink-400/20 mb-4">
                        <p className="text-xs text-pink-300 font-medium">
                          💬 "Book beauty service tomorrow"
                        </p>
                      </div>
                    </div>

                    <Button
                      className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white shadow-md hover:shadow-pink-500/30 transition-all duration-300"
                      onClick={() =>
                        handleBookService("beauty", "Beauty & Salon")
                      }
                    >
                      Book Now
                      <ArrowRight className="ml-2 w-4 h-4" />
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="lg:col-span-4 lg:row-span-1 group relative"
              >
                <div className="h-full relative bg-gradient-to-br from-emerald-500/10 via-green-500/10 to-teal-600/10 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:border-emerald-400/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(16,185,129,0.3)]">
                  <div className="relative h-full p-6 flex flex-col justify-between">
                    <div className="relative mb-4 inline-flex">
                      <div className="absolute inset-0 bg-emerald-500/30 blur-xl rounded-full" />
                      <div className="relative bg-gradient-to-br from-emerald-500 via-green-500 to-teal-600 p-4 rounded-xl shadow-xl transform group-hover:rotate-6 transition-all duration-500">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm mb-4">
                        Transform spaces with skilled painters
                      </p>

                      <div className="p-3 bg-emerald-500/10 backdrop-blur-sm rounded-lg border border-emerald-400/20 mb-4">
                        <p className="text-xs text-emerald-300 font-medium">
                          💬 "Book painter for weekend"
                        </p>
                      </div>
                    </div>

                    <Button
                      className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-md transition-all duration-300"
                      onClick={() => handleBookService("painter", "Painting")}
                    >
                      Book Now
                    </Button>
                  </div>
              ...
              <motion.div
                ...
                className="lg:col-span-4 lg:row-span-1 group relative"
              >
                <div className="h-full relative bg-gradient-to-br from-red-500/10 via-rose-600/10 to-pink-700/10 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:border-red-400/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(239,68,68,0.3)]">
                  <div className="relative h-full p-6 flex flex-col justify-between">
                    <div className="relative mb-4 inline-flex">
                      <div className="absolute inset-0 bg-red-500/30 blur-xl rounded-full" />
                      <div className="relative bg-gradient-to-br from-red-500 via-rose-600 to-pink-700 p-4 rounded-xl shadow-xl transform group-hover:rotate-6 transition-all duration-500">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm mb-4">
                        Mobile mechanics for your vehicle
                      </p>

                      <div className="p-3 bg-red-500/10 backdrop-blur-sm rounded-lg border border-red-400/20 mb-4">
                    ...
                    <Button
                      className="w-full bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white shadow-md transition-all duration-300"
                      onClick={() =>
                        handleBookService("mechanic", "Auto Repair")
                      }
                    >
                      Book Now
                    </Button>
              ...
              <motion.div
                ...
                className="lg:col-span-4 lg:row-span-1 group relative"
              >
                <div className="h-full relative bg-gradient-to-br from-violet-500/10 via-purple-600/10 to-indigo-700/10 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:border-violet-400/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(139,92,246,0.3)]">
                  <div className="relative h-full p-6 flex flex-col justify-between">
                    <div className="relative mb-4 inline-flex">
                      <div className="absolute inset-0 bg-violet-500/30 blur-xl rounded-full" />
                      <div className="relative bg-gradient-to-br from-violet-500 via-purple-600 to-indigo-700 p-4 rounded-xl shadow-xl transform group-hover:rotate-6 transition-all duration-500">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="p-3 bg-violet-500/10 backdrop-blur-sm rounded-lg border border-violet-400/20 mb-4">
                    ...
                    <Button
                      className="w-full bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white shadow-md transition-all duration-300"
                      onClick={() =>
                        handleBookService("cleaner", "Home Cleaning")
                      }
                    >
                      Book Now
                    </Button>
