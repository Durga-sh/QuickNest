class VoiceBookingParser {
  ...
  extractService(text) {
    try {
      ...
      console.error("Error extracting service:", error);
    }
    return null;
  }
  extractDate(text) {
  ...
  containsAny(text, keywords) {
    try {
      ...
      console.error("Error in containsAny:", error);
      return false;
    }
  }
  capitalizeFirst(str) {
  ...
  getNextDateForDay(dayName) {
    try {
      ...
      console.error("Error getting next date for day:", error);
      return new Date();
    }
  }
  generateBookingData(parsedCommand) {
    try {
      const bookingData = {
        ...
        bookingDate: null,
        timeSlot: null,
        urgent: parsedCommand?.urgent || false,
  ...
  getSuggestions(parsedCommand) {
    try {
      ...
      return ["Please try again with more specific details"];
    }
  }
}
